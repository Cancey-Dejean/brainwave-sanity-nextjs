...
export default function ServiceCard1({mainImage, mainImageAlt, title, description, chatMessage}: ServiceCard1Props) {
  return (
    <div className="relative min-h-[39rem] overflow-hidden rounded-3xl max-w-[628px] w-full border border-n-1/10">
        {/* <img src="/images/services/service-2.png" alt="" /> */}
        <Image
                src={mainImage || "/images/services/service-2.png"}
        ...
        {/* <PhotoChatMessage text="Chat Message" /> */}
    </div>
  )
}
